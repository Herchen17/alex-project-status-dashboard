...
class ClinicValidator {
     ...
     */
    static validateContactPerson(person) {
        const errors = [];
...
exports.ClinicValidator = ClinicValidator;
//# sourceMappingURL=clinicValidator.js.map